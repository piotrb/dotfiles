...
plan do
  ...
  # NOTE: bin/ launcher stubs (ruby/node/python) and the ~/.tsi pre-render are
  # generated by a separate bootstrap step (src/make_stubs.rb + bin/df-compile),
  # not here. install.rb only links whatever already exists in bin/.
  ...
  # bin/df-compile (run from a bootstrap step), and sourced by zshenv/zshrc/bashrc.
